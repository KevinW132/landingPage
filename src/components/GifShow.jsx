...
export default function PopupWithGif({ isOpen, onClose }) {
    ...
    return (
        <div className="z-50 fixed !ml-0 inset-0 bg-black/50 flex items-center justify-center">
            <div className="z-50 h-full bg-white p-6 rounded-lg shadow-lg relative">
                <button
                    onClick={onClose}
